  ...
  return (
    <section id='home' className="container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full md:w-1/2 space-y-8">
       ...
       >
        ...
        className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight ">
          ...
          Companies<span className="inline-bloxk ml-2 animate-pulse">⏰</span>
        </motion.h1>
        <motion.p 
        ...
        className="text-gray-600 text-lg md:text-xl max-w-xl">
          ...
          conversion,tools and more-all within the same one billing.
        </motion.p>
        <motion.div 
        variants= {fadeIn('right',0.2)}
           initial='hidden'
      ...
      variants= {fadeIn('left',0.5)}
           initial='hidden'
           whileInView='show'
       className="w-full md:w-1/ mt-16 md:mt-0 pl-0 md:pl-12">
        <div className="relative ">
            <img src={heroImage} alt="hero image" className="rounded-lg relative z-10 hover:scale-[1.02] transition-transform-300"/>
        </div>
      </motion.div>
    </section>
  );
